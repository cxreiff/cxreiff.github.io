...
export const GITHUB_SITE_PROJECT_URL = 'https://github.com/cxreiff/cxreiff.github.io'

export const OBJECT_STORE_ASSETS_URL = 'https://cxreiff.sfo3.cdn.digitaloceanspaces.com/'
